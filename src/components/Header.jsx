...
import { Menu, X, Users, FileText, Phone, Pickaxe, Earth, Video, ChevronDown, GalleryVertical, NotebookTabs, GalleryThumbnails, Hand, Handshake, LetterTextIcon, Mail } from 'lucide-react';
...
const Header = () => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      icon: FileText,
      children: [
        { name: 'News', href: '/media/news', icon: Earth },
                  ...
                  {item.children ? (
                    <div className="mobile-nav-split-item">
                      <div className="mobile-nav-split-wrapper">
                        ...
                        >
                          <ChevronDown
                            className={`mobile-dropdown-icon ${isMobileDropdownOpen === item.name ? 'rotate' : ''}`}
                            size={16}
                          />
                        </button>
                      </div>
